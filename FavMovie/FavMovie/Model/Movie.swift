...
let myMovies =
    [
        ...
        Movie(MovieName: "The Curious Case Of Benjamin", MovieAct: ["Brad Pitt", "Cate Blanchett"], MovieStory: "Tells the story of Benjamin Button, a man who starts aging backwards with consequences"),
